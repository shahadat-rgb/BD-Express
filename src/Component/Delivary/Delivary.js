        ...
        <div className='container'>
            ...
            <div className="row mb-5">
                <div className="col-md-4 delivary">
                     ...
                     <h5 className="text-success"> <FontAwesomeIcon icon={faPhoneAlt}> </FontAwesomeIcon>  +88704745454</h5>
                </div>
                <div className="col-md-4 delivary">
                <img style={{height:"300px"}} src={delivary2} alt="" />
                     <h3 className='text-warning'>DM. Sultan hanif</h3>
                     <h5 className="text-success"> <FontAwesomeIcon icon={faPhoneAlt}> </FontAwesomeIcon>  +88798577854</h5>
                </div>
                <div className="col-md-4 delivary">
                <img style={{height:"300px"}} src={delivary3} alt="" />
                     <h3 className='text-warning'>DM. Miycel piti</h3>
                     <h5 className="text-success"> <FontAwesomeIcon icon={faPhoneAlt}> </FontAwesomeIcon>  +88458349058</h5>
                </div>
            </div>
        </div>
    );
